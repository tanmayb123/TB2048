...
GameManager.prototype.automove = function () {
  var self = this;
  const tiles = [].concat.apply([], this.grid.cells)
  var cleanedTiles = [];
  ...
  fetch('http://tb2048.mybluemix.net/analyze?board=' + cleanedTiles.join("%2C")).then(function (response) {
...
GameManager.prototype.move = function (direction) {
  // 0: up, 1: right, 2: down, 3: left, 4: auto
  var self = this;
